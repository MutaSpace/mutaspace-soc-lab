# packer/win11-client/scripts/10-cloudbase-init.ps1
#
# WHAT THIS IS
...
if ([string]::IsNullOrWhiteSpace($msiUrl)) {
    throw 'CLOUDBASE_INIT_MSI_URL was not passed to this provisioner. Check the environment_vars block in win11-client.pkr.hcl.'
}
