# packer/win-server-2022/cd/setup.ps1
#
# WHAT THIS IS
...
#   packer/win11-client/cd/setup.ps1 is a near-copy. The two templates are independent
#   build units with different media, different driver directories and different
#   licensing constraints, and a shared file across sibling Packer directories is
#   fragile (relative paths resolve against the template folder). Keep them in sync by
#   hand; the differences are commented where they exist.
