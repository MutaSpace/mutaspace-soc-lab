# packer/win11-client/scripts/00-virtio-guest-tools.ps1
#
# WHAT THIS IS
...
#                                        matter what the hypervisor asks for. That
#                                        matters more here than on the server
#                                        template: the RAM budget only supports about
#                                        three concurrent learners with private
#                                        endpoints, and this is the endpoint they get.
#     * qemu-ga                        - already installed by cd/setup.ps1; the MSI
#                                        here upgrades/repairs it harmlessly.
#     * vioinput, viorng, pvpanic, etc.
#
#   The MSI is the same file for both Windows templates. virtio-win-gt-x64.msi picks
#   the right driver set per OS version itself; only the windowsPE DriverPaths in the
#   answer file have to name w11 rather than 2k22 directories.
#
