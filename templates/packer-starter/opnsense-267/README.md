...
NTP server and — per decision D-04 — the intrusion detection sensor for the Example Lab.
...
| Area | Value |
|---|---|
| Hostname / domain | `fw-01` / `example.local` |
...
| DHCP options | Gateway `10.10.10.1`, DNS `10.10.10.10` (dc-01), domain `example.local`, NTP `10.10.10.1` |
